...
void loop () {
  ...
  if ( fecha.hour() == 20 && fecha.minute() == 32 ) { // si hora = 14 y minutos = 30
  ...
  mostrarFechaHorario(fecha);

  delay(1000);           // demora de 1 segundo

  if ( fecha.hour() == 20 && fecha.minute() == 30 )   // si hora = 2 y minutos = 0 restablece valor de
    alarma = true;          // variable de control en verdadero
}

void mostrarFechaHorario(DateTime fecha) {
